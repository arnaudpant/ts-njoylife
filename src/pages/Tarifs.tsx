            ...
            <div className="container px-2 mx-auto mb-4 mt-10 max-w-3xl">
                ...
                <div className="grid grid-cols-5 gap-x-2 gap-y-1 rounded-xl">
                    ...
                    <div className="bg-tealE col-span-5 rounded-xl  py-1">
                        <h2 className="text-center text-xl">COACHING</h2>
                    </div>
                    ...
                    <div className="bg-tealE col-span-5 mt-8 rounded-xl text-center text-xl py-1">
                        <h2 className="text-center text-xl">MASSAGES & REFLEXOLOGIE</h2>
                    </div>
                    ...
                    <div className="bg-tealE col-span-5 mt-8 rounded-xl text-center text-xl py-1">
                        <h2 className="text-center text-xl">COURS COLLECTIFS</h2>
                    </div>
                    ...
                    <div className="bg-tealE col-span-5 mt-8 rounded-xl text-center text-xl py-1">
                        <h2 className="text-center text-xl">ATELIERS</h2>
                    </div>
                    <div className="bg-tealC col-span-4 pl-2">Relaxation sonore - 60min</div>
                    <div className="bg-tealC text-center">15€/ Pers</div>
                    <div className="bg-tealC col-span-4 pl-2">Cercle de pardon - 2H30</div>
