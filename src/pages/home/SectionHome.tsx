    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center justify-evenly h-3/5 mx-4 md:mx-0 mt-12 md:mt-0 md:w-1/2 md:h-auto md:pr-10 xl:pr-20">
                ...
                <p className="text-xl md:text-2xl text-noir md:pt-4 text-center">
                    "Osez devenir qui vous Êtes"
                </p>
            </div>
            ...
            <div className="relative flex justify-center pb-4 h-2/5 md:w-2/5 lg:w-1/2 md:h-auto md:m-10 z-0">
                ...
                <div className="absolute top-2 right-6 md:right-4 md:top-5 w-9 lg:w-16 md:w-12 animate-[plumerotate_3s_linear_infinite]">
                    <svg
                        version="1.1"
                        viewBox="0 0 120.6 111.4"
                        enableBackground="new 0 0 120.6 111.4"
                    >
                        <path
                            fill="#36b3a2"
                            d="M51.9,107.2C25.8,107.6,9.4,81.7,9.4,81.7c21.3,11.3,30,3.3,30,3.3C18,89.8,2.2,73.2,2.2,73.2
