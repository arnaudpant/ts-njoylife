...
import BoutonSmall from "../UI/buttons/BoutonSmall";
...
const Footer = () => {
    ...
    return (
        <footer className="bg-tealI text-tealA p-4 flex flex-col items-center justify-around gap-4 pt-8">
            {/* Navigation et logo */}
            <div className="flex flex-col md:flex-row w-full gap-8">
                ...
                <div className="md:w-1/3 md:px-10 flex flex-col items-center">
                    ...
                    <h2 className="text-xl pt-8 pb-4">Adresse</h2>
                    <p>78 Route de l’Arpenteur</p>
                    <p>26300 Marches</p>
                </div>
            </div>
            {/* Infos légales */}
            ...
            <div>
                <p className="text-xs">
                    Site créé par <a href="https://kallavero.fr">Arnaud P.</a>{" "}
                    &copy; {yearFooter}
                </p>
            </div>
        </footer>
